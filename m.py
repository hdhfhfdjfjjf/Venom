...
bot = telebot.TeleBot('7501498072:AAGY9V0qzE3dM-uaC2XdZQQHzBBxfYmgTws')
...
✅ Usage: /remove <userid>'''
        ...
        response = "You have not purchased yet purchase now from:-@HIMANSHU_PAPA_BOL  🙇."
...
def start_attack_reply(message, target, port, time):
    ...
    response = f"{username}, 𝐀𝐓𝐓𝐀𝐂𝐊 𝐒𝐓𝐀𝐑𝐓𝐄𝐃.🔥🔥\n\n𝐓𝐚𝐫𝐠𝐞𝐭: {target}\n𝐏𝐨𝐫𝐭: {port}\n𝐓𝐢𝐦𝐞: {time} 𝐒𝐞𝐜𝐨𝐧𝐝𝐬\n𝐌𝐞𝐭𝐡𝐨𝐝: VIP- User of @HIMANSHU_PAPA_BOL"
    bot.reply_to(message, response)
...
def handle_bgmi(message):
    ...
    if user_id in allowed_user_ids:
        ...
        response = ("🚫 Unauthorized Access! 🚫\n\nOops! It seems like you don't have permission to use the /bgmi command. DM TO BUY ACCESS:- @HIMANSHU_PAPA_BOL")
...
def welcome_start(message):
    ...
    response = f'''🔥Welcome To Battlefield 🔥, {user_name}! 🔥.
...
3. Play 2 Matches With Dodos And 2 Normal Unranked Or Arena
